              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                {step === 1 && (
                  <div className="space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-3 text-center">
                      <h2 className="text-3xl font-bold text-[#434343]">Bem-vindo ao JuridicAI</h2>
                    ...
                    <div className="space-y-6 md:space-y-8">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
                        ...
                        <div className="order-2 md:order-1">
                          <p className="font-bold text-[#434343] mb-6">
                ...
                {step === 2 && (
                  <div className="space-y-6 md:space-y-8">
                    ...
                    <div className="space-y-3">
                      <h2 className="text-3xl font-bold text-[#434343]">Dados do Escritório</h2>
                      <p className="text-base text-[#6E6E6E]">
                ...
                {step === 3 && (
                  <div className="space-y-6 md:space-y-8">
                    {/* Header integrado */}
                    <div className="space-y-3">
                      <h2 className="text-3xl font-bold text-[#434343]">Áreas de Atuação</h2>
                      <p className="text-base text-[#6E6E6E]">
