    ...
    <Card>
      ...
      <CardContent className="p-0">
        <div className="space-y-0">
          {clients.map((client) => (
            <div key={client.id} className="p-5 bg-gradient-to-r from-primary/8 via-primary/5 to-primary/3 backdrop-blur-xl hover:from-primary/12 hover:via-primary/8 hover:to-primary/5 transition-all duration-300">
