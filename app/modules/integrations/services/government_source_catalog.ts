...
export const governmentSourceCatalog: GovernmentSourceRecord[] = [
  ...
  },
  {
    ...
    access: 'public',
    priority: 'primary',
    baseUrl: 'https://www.trf1.jus.br/trf1/rpv-e-precatorios/rpv-e-precatorioss',
    notes:
      'Official TRF1 public page for federal proposals, subnational/entity proposals, repasses, consolidated debt and annual debt maps.',
    constraints: [
      'The page mixes federal and subnational reports, so each discovered file must keep sourceKind metadata.',
      'Some links are generated by the portal and should be stored as source_records before parsing.',
      'Use this source as raw discovery and reconcile canonical process metadata through DataJud/DJEN.',
    ],
    courtAliases: ['trf1'],
  },
  {
    id: 'trf3-cnj-102-precatorios-rpv',
    ...
    notes:
      'Official monthly TRF3 CSV, PDF and XLSX reports for precatorios and RPVs under CNJ Resolution 102/2009 Annex II.',
    constraints: [
      'The public page is the source of truth because file URLs and monthly availability change over time.',
      'CSV/XLSX files should be stored as source_records before canonical row parsing.',
      'Use alongside DataJud and DJEN because this report is a transparency publication, not a full lawsuit event feed.',
    ],
    courtAliases: ['trf3'],
  },
  {
