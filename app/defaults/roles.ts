...
export const DEFAULT_ROLES = [
  { name: 'Root', slug: IRole.Slugs.ROOT, description: 'System administrator with all permissions' },
  ...
  { name: 'Editor', slug: IRole.Slugs.EDITOR, description: 'Content editor with editing permissions' },
]
